 ...
 */
$router->post('/payments/confirm', function (Request $request) {
 ...
 * @response 422 "Validation failed"
 */
$router->post('/plans', function (Request $request) {
 ...
 */
$router->post('/plans/update', function (Request $request) {
    $controller = new BillingPlanController();
 ...
 * @response 404 "Plan not found"
 */
$router->post('/plans/disable', function (Request $request) {
    $controller = new BillingPlanController();
 ...
 */
$router->get('/plans', function (Request $request) {
    $controller = new BillingPlanController();
 ...
 * @response 422 "Validation failed"
 */
$router->post('/invoices', function (Request $request) {
 ...
 */
$router->post('/invoices/mark-paid', function (Request $request) {
    $controller = new InvoiceController();
    return $controller->markPaid($request);
})->middleware(['auth', 'rate_limit:60,60']);
 ...
 * @response 404 "Invoice not found"
 */
$router->post('/invoices/cancel', function (Request $request) {
    $controller = new InvoiceController();
 ...
 */
$router->get('/invoices', function (Request $request) {
    $controller = new InvoiceController();
    return $controller->index($request);
})->middleware(['auth', 'rate_limit:60,60']);
